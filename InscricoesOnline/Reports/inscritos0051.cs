...
namespace InscricoesOnline.Reports {
    ...
    public class inscritos005 : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "InscricoesOnline.Reports.inscritos005.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class Cachedinscritos005 : Component, ICachedReport {
        
        public Cachedinscritos005() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            inscritos005 rpt = new inscritos005();
            rpt.Site = this.Site;
            return rpt;
        }
